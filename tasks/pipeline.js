...
var cssDependencies = [ 'dependencies/**/*.css', ];
...
var jsDependencies = [
  ...
  'dependencies/chart/Chart.min.js',
  'dependencies/chart/chartjs-plugin-labels.js',
  'dependencies/angular-chart/angular-chart.js',
...
module.exports.cssDependencies = cssDependencies.map( ( cssPath ) => {
  // If we're ignoring the file, make sure the ! is at the beginning of the path
  if ( cssPath[0] === '!' ) {
    return require( 'path' ).join( '!' + tmpPath, cssPath.substr( 1 ) );
  }
...
module.exports.jsDependencies = jsDependencies.map( ( jsPath ) => {
  // If we're ignoring the file, make sure the ! is at the beginning of the path
  if ( jsPath[0] === '!' ) {
    return require( 'path' ).join( '!' + tmpPath, jsPath.substr( 1 ) );
  }
