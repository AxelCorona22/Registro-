ng.config( [
  ...
  '$sailsProvider',
  'calendarConfig',
  function ( $httpProvider, $provide, $qProvider, $sailsProvider, calendarConfig ) {
        ...
        return {
          'request': function ( config ) {
            ...
            if ( config.method !== 'GET' && SAILS_LOCALS._csrf ) {
              ...
              config.headers['x-csrf-token'] = SAILS_LOCALS._csrf;
    ...
    $sailsProvider.config.reconnectionDelay = 5000;
  },
] );
