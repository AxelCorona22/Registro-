...
module.exports = {
  ...
  fn: async function ( inputs, exits ) {
    ...
    var userRecord = await Usuarios.findOne( { emailAddress: inputs.emailAddress } );
    if ( !userRecord ) {
    ...
    await Usuarios.update( { id: userRecord.id } ).set( {
      ...
      passwordResetTokenExpiresAt: moment().add( sails.config.custom.passwordResetTokenTTL, 'hours' ).
